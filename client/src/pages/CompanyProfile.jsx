...
import { companies, jobs } from "../utils/data.js";
...
{
  user?.accountType === undefined && info?._id === user?._id && ( <div className="flex items-center justify-center py-5 md:py-0 gap-4">
    <CustomButton 
